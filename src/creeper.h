...
constexpr vec2 creeperBodyRotationCenter = cvec2(creeperBodySize.getX() * 0.5, 0);
...
constexpr vec2 creeperFrontLegRotationCenter = cvec2(0, creeperLegSize.getY());
constexpr vec2 creeperBackLegRotationCenter = creeperLegSize;

constexpr vec2 creeperFrontLegOffset = cvec2(creeperBodySize.getX(), 0) - creeperBodyRotationCenter;
constexpr vec2 creeperBackLegOffset = -creeperBodyRotationCenter;

constexpr vec2 creeperHeadSize = cvec2(creeperHeadTextureRect.size) * creeperTextureScale;
constexpr vec2 creeperHeadRotationCenter = cvec2(creeperHeadSize.getX() * 0.5, 0);
