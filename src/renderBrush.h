...
//void renderBrush(rectangle2 brushRect, mat3x3 transform, cvec2& rotationCenter, cbool& hasTransparency, const directionID& directionFacing, cbool& renderAnimation, const brush0Type& b, const texture& renderTarget);
//template<typename brush0Type>
...
#include "settings.h"
template<typename brush0Type>
inline void renderBrush(rectangle2 brushRect, mat3x3 transform, cvec2& rotationCenterOnScreen, cbool& hasTransparency, const directionID& directionFacing, const brush0Type& b, const texture& renderTarget, cbool& renderAnimation = false)
{
	...
	{
		transform = mat3x3::cross(mat3x3::mirror(axisID::y, rotationCenterOnScreen.y), transform);
	}

	if (directionFacing == directionID::negativeX || directionFacing == directionID::positiveX)
	{
		transform = mat3x3::cross(mat3x3::rotateDegrees(rotationCenterOnScreen, 90), transform);
	}
